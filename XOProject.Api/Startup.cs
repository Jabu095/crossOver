...
namespace XOProject.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Cross Over API Documentation", Version = "v1", Description = "this API makes use of json response", Contact = new Contact() { Email = "jaybeedzivas@gmail.com", Name = "Jabulani Madzivadondo" } });
